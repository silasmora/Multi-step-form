  ...
  return (
    <form onSubmit={handlesubmit} className='h-[568px] w-[70%] md:px-10'>
      ...
      <div className='mx-4 py-8 px-6 bg-white rounded-lg absolute top-28 left-0 right-0 md:relative md:top-0 md:mx-0 md:h-[80%]'>
        ...
        <h1 className='text-marineBlue font-bold text-2xl md:text-3xl lg:text-4xl'>Pick add-ons</h1>
        <p className='py-4 text-coolGray'>Add-ons help enhance your gaming experience.</p>
        <div className='mt-8'>
